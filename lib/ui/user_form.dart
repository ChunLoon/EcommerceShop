...
class _UserFormState extends State<UserForm> {
  ...
  Future<void> _selectDateFromPicker(BuildContext context) async {         //choose date
  ...
  sendUserDataToDB()async{
    ...
    var  currentUser = _auth.currentUser;  //without this two line documets name in  is random else is email
